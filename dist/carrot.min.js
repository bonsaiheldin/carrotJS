...
void 0!==d?d.innerHTML=a:(d=document.createElement("div"),this.game.background.appendChild(d),d.className="debugText",d.style.position="absolute",d.style.left=b+"px",d.style.top=c+"px",d.style.color="#ffffff",d.style.fontSize="16px",d.style.lineHeight="20px",d.style.textShadow="1px 1px 0px #111111",d.style.userSelect="none",d.style.pointerEvents="none")}};Carrot.Debug.prototype.constructor=Carrot.Debug;Carrot.SPRITE=0;Carrot.TILESPRITE=1;Carrot.GROUP=2;
