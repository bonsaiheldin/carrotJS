...
e.parent.style.width=e.width+"px";e.parent.style.height=e.height+"px";e.time=new Carrot.Time(e);e.debug=new Carrot.Debug(e);e.utils=new Carrot.Utilities(e);e.physics=new Carrot.Physics(e);e.math=new Carrot.Math(e);e.world=new Carrot.World(e);e.camera=new Carrot.Camera(e);e.cache=new Carrot.Cache(e);e.load=new Carrot.AssetLoader(e);e.add=new Carrot.ObjectFactory(e);e.sound=new Carrot.SoundManager(e);e.keyboard=new Carrot.Keyboard(e);e.mouse=new Carrot.Mouse(e);e.roundPixels=!1;if(null!==e.scene&&e.scene.preload){e.background.style.background=
...
Carrot.Game.prototype={start:function(a){MainLoop.setUpdate(function(b){a._update(b)}).setDraw(function(){a._render()}).start();null!==this.scene&&this.scene.create&&this.scene.create()},setBounds:function(a,b){this.width=a;this.height=b;void 0===a&&(this.width=800);void 0===b&&(this.height=600);this.background.style.width=this.width+"px";this.background.style.height=this.height+"px"},setBoundsToCamera:function(){this.width=this.camera.width;this.height=this.camera.height;this.background.style.width=
this.width+"px";this.background.style.height=this.height+"px"},setBoundsToWorld:function(){this.width=this.world.width;this.height=this.world.height;this.background.style.width=this.width+"px";this.background.style.height=this.height+"px"},setCursor:function(a,b,c){void 0===b&&(b=0);void 0===c&&(c=0);if(void 0===a)this.background.style.cursor="";else{var d=this.cache.images[a];this.background.style.cursor=void 0!==d?"url("+d.src+") "+b+" "+c+", default":a}},_update:function(a,b,c){this.time._update(a);
this.world._update();this.camera._update();null!==this.scene&&this.scene.update&&this.scene.update()},_render:function(a,b,c){this.world._render();this.camera._render();null!==this.scene&&this.scene.render&&this.scene.render()}};Carrot.Game.prototype.constructor=Carrot.Game;
Carrot.World=function(a){this.game=a;this.camera=new Carrot.Camera(this.game);this.y=this.x=0;this.width=this.game.width;this.height=this.game.height;this.bounds=new Carrot.Rectangle(this.x,this.y,this.width,this.height);this.children=[];return this};
Carrot.World.prototype={addChild:function(a){a.parent!==this&&a.parent.removeChild(a);this.children.push(a);a.parent=this},removeChild:function(a){this.children.splice(this.children.indexOf(a),1)},create:function(a,b,c,d,g){a=this.game.add.sprite(a||0,b||0,c||null,d||0,g||!1);this.addChild(a);return a},createMultiple:function(a,b,c,d,g,e){a=a||1;b=b||0;c=c||0;d=d||null;g=g||0;e=e||!1;for(var f=[],h=0;h<a;h++){var k=this.game.add.sprite(b,c,d,g,e);this.addChild(k);f.push(k)}return f},setBounds:function(a,
b,c,d){this.y=this.x=0;this.width=c;this.height=d;void 0===a&&(this.x=0);void 0===b&&(this.y=0);void 0===c&&(this.width=800);void 0===d&&(this.height=600)},setBoundsToGame:function(){this.width=this.game.width;this.height=this.game.height},setBoundsToCamera:function(){this.width=this.camera.width;this.height=this.camera.height},_update:function(){for(var a=0;a<this.children.length;a++){var b=this.children[a];b.active&&(b._update(),b.update&&b.update())}},_render:function(){for(var a=0;a<this.children.length;a++)this.children[a]._render()}};
Carrot.World.prototype.constructor=Carrot.World;Carrot.Camera=function(a){this.game=a;this.world=this.game.world;this.y=this.x=0;this.width=this.game.width;this.height=this.game.height;this.bounds=new Carrot.Rectangle(this.x,this.y,this.width,this.height);this.left=this.x;this.right=this.x+this.width;this.top=this.y;this.bottom=this.y+this.height;this.roundPixels=!1;this._x=this.x;this._y=this.y;this.target=null;return this};
Carrot.Camera.prototype={setBounds:function(a,b){this.width=a;this.height=b;void 0===a&&(this.width=800);void 0===b&&(this.height=600)},setBoundsToGame:function(){this.width=this.game.width;this.height=this.game.height},setBoundsToWorld:function(){this.width=this.world.width;this.height=this.world.height},follow:function(a){a&&(this.target=a)},unfollow:function(){this.target=null},_update:function(){if(null!==this.target){this._x=this.x;this._y=this.y;var a=this.target.x,b=this.target.y,c=.5*this.width,
d=.5*this.height;a>c&&a<=this.world.width-c&&(this.x=a-.5*this.width);b>d&&b<=this.world.height-d&&(this.y=b-d)}if(this.game.roundPixels||this.roundPixels)this.x=Math.round(this.x),this.y=Math.round(this.y);this.left=this.x;this.right=this.left+this.width;this.top=this.y;this.bottom=this.top+this.height},_render:function(){if(this.x!==this._x||this.y!==this._y)this.game.parent.style.left=-this.x+"px",this.game.parent.style.top=-this.y+"px"}};Carrot.Camera.prototype.constructor=Carrot.Camera;
...
Carrot.Sprite=function(a,b,c,d,g,e){this.x=b;this.y=c;this.key=d;this.frame=g;this.active=e;this.damage=this.health=0;void 0===b&&(this.x=0);void 0===c&&(this.y=0);void 0===d&&(this.key=null);void 0===g&&(this.frame=0);void 0===e&&(this.active=!0);this.game=a;this.world=this.game.world;this.camera=this.game.camera;this.time=this.game.time;this.type=Carrot.SPRITE;this.parent=this.world;this.children=[];this.alpha=1;this.height=this.width=32;this.anchor=new Carrot.Point(0,0);this.left=this.x-this.width*
this.anchor.x;this.right=this.left+this.width;this.top=this.y-this.height*this.anchor.y;this.bottom=this.top+this.height;this.inCamera=this.outOfBoundsKill=!1;this.transform="";this.angle=0;this.roundPixels=!1;this._x=this.x;this._y=this.y;this._angle=this.angle;this._alpha=this.alpha;this.style=this.image=this.body=null;this.visible=!0;this.events=new Carrot.Events(this);this.active&&this.revive();this.parent.addChild(this);this.name="Unknown sprite";return this};
...
"px";0!==this.frame&&(b=b.frames[this.frame],this.image.style.backgroundPosition=b.x+"px "+b.y+"px")}this.image.style.left=this.x-this.width*this.anchor.x+"px";this.image.style.top=this.y-this.height*this.anchor.y+"px";this.game.parent.appendChild(this.image);return a}},destroyNode:function(){null!==this.image&&(this.image.parentNode.removeChild(this.image),this.style=this.image=null)},addChild:function(a){null!==a.image&&(this.game.parent.removeChild(a.image),this.image.appendChild(a.image),a.image.style.left=
a.x-a.width*a.anchor.x+"px",a.image.style.top=a.y-a.height*a.anchor.y+"px");a.parent!==this&&a.parent.removeChild(a);this.children.push(a);a.parent=this},removeChild:function(a){this.image.removeChild(a.image);this.game.parent.appendChild(a.image);this.children.splice(this.children.indexOf(a),1)},kill:function(a){this.events.onKilled();this.parent.removeChild(this);this.visible=this.active=!1;this.parent.addChild(this);a&&this.destroyNode()},revive:function(){this.events.onRevived();this.parent.removeChild(this);
this.visible=this.active=!0;this.parent.addChild(this);this.createNode()},destroy:function(a){this.events.onDestroyed();a=a||!1;for(var b=0;b<this.children.length;b++){var c=this.children[b];a?c.destroy(!0):this.removeChild(c)}this.parent.removeChild(this);this.destroyNode()},setFrame:function(a){a=this.game.cache.images[this.key].frames[a||0];this.image.style.backgroundPosition=a.x+"px "+a.y+"px"},setGlow:function(a,b,c,d){!1!==a?(c=c||Carrot.Color.Lime,this.image.style.boxShadow="0px 0px "+((a||
0)+"px ")+((b||0)+"px ")+c+(d?" inset":"")):void 0===a&&(this.image.style.boxShadow="")},update:function(){},_update:function(){this._x=this.x;this._y=this.y;this._angle=this.angle;this._alpha=this.alpha;this._transform=this.transform;var a=this.world.width,b=this.world.height;this.inCamera=!1;this.right>this.camera.left&&this.bottom>this.camera.top&&this.left<this.camera.right&&this.top<this.camera.bottom&&(this.inCamera=!0);if(null!==this.body&&this.body.enabled){this.body.touching.none=!0;this.body.touching.left=
!1;this.body.touching.right=!1;this.body.touching.top=!1;this.body.touching.bottom=!1;0!==this.body.angularVelocity&&(this.angle+=this.body.angularVelocity*this.time.delta);this.body.allowAngularDrag&&0<this.body.angularDrag&&(this.angle+=1-this.body.angularDrag);this.body.allowAcceleration&&(this.body.velocity.x+=this.body.acceleration.x*this.time.delta,this.body.velocity.y+=this.body.acceleration.y*this.time.delta);this.body.allowGravity&&(this.body.velocity.x+=this.body.gravity.x*this.time.delta,
this.body.velocity.y+=this.body.gravity.y*this.time.delta);this.body.allowDrag&&(this.body.velocity.x*=1-this.body.drag.x,this.body.velocity.y*=1-this.body.drag.y);var c=this.body.maxVelocity.x,d=this.body.maxVelocity.y;this.body.velocity.x>c?this.body.velocity.x=c:this.body.velocity.x<-c&&(this.body.velocity.x=-c);this.body.velocity.y>d?this.body.velocity.y=d:this.body.velocity.y<-d&&(this.body.velocity.y=-d);this.x+=this.body.velocity.x*this.time.delta;this.y+=this.body.velocity.y*this.time.delta;
if(this.game.roundPixels||this.roundPixels)this.x=Math.round(this.x),this.y=Math.round(this.y);this.body.collideWorldBounds&&!1===this.body.checkCollision.none&&(this.body.checkCollision.left&&this.x<=this.width&&(this.x=this.width,this.body.touching.none=!1,this.body.touching.left=!0,this.body.allowBounce&&(this.body.velocity.x=-(this.body.velocity.x*this.body.bounce.x))),this.body.checkCollision.right&&this.x+this.width>=a&&(this.x=a-this.width,this.body.touching.none=!1,this.body.touching.right=
!0,this.body.allowBounce&&(this.body.velocity.x=-(this.body.velocity.x*this.body.bounce.x))),this.body.checkCollision.top&&this.y<=this.height&&(this.y=this.height,this.body.touching.none=!1,this.body.touching.top=!0,this.body.allowBounce&&(this.body.velocity.y=-(this.body.velocity.y*this.body.bounce.y))),this.body.checkCollision.bottom&&this.y+this.height>=b&&(this.y=b-this.height,this.body.touching.none=!1,this.body.touching.bottom=!0,this.body.allowBounce&&(this.body.velocity.y=-(this.body.velocity.y*
this.body.bounce.y))))}this.outOfBoundsKill&&(0>this.left||this.right>a||0>this.top||this.bottom>b)&&this.kill(!0);this.left=this.x;this.right=this.x+this.width;this.top=this.y;this.bottom=this.y+this.height;this.transform="";0!==this.angle&&(this.transform+=" rotate("+this.angle+"deg) ");for(a=0;a<this.children.length;a++)b=this.children[a],b.active&&(b._update(),b.update&&b.update())},_render:function(){if(this.active){!1===this.inCamera?!0===this.visible&&(this.visible=!1,this.style.display="none"):
(!1===this.visible&&(this.visible=!0,this.style.display=""),this.alpha!==this._alpha&&1>this.alpha&&(this.style.opacity=this.alpha),this.x!==this._x&&(this.image.style.left=this.x-this.width*this.anchor.x+"px"),this.y!==this._y&&(this.image.style.top=this.y-this.height*this.anchor.y+"px"),this.transform!==this._transform&&(this.style.transform=this.transform));for(var a=0;a<this.children.length;a++)this.children[a]._render()}}};Carrot.Sprite.prototype.constructor=Carrot.Sprite;
Carrot.Time=function(a){this.game=a;this.lastFrame=this.now=performance.now();this.delta=1E3/60;this.timers=[];return this};Carrot.Time.prototype={_update:function(a){this.lastFrame=this.now;this.now=performance.now();this.lastFrame=this.now-this.lastFrame;this.delta=a/1E3;for(a=0;a<this.timers.length;a++)this.timers[a]._update(this.lastFrame)}};Carrot.Time.prototype.constructor=Carrot.Time;
...
a.x,b.y-a.y)}};Carrot.Math.prototype.constructor=Carrot.Math;Carrot.SoundManager=function(a){this.game=a;return this};
Carrot.SoundManager.prototype={play:function(a,b,c){if(a=this.game.cache.sounds[a])void 0!==c&&(a.loop=c),a.volume=b,a.paused||(a.pause(),a.currentTime=0),a.play()},stop:function(a){(a=this.game.cache.sounds[a])&&!a.paused&&(a.loop=!1,a.currentTime=0,a.stop())},resume:function(a){(a=this.game.cache.sounds[a])&&a.paused&&(a.loop=!1,a.currentTime=0,a.stop())},pause:function(a){(a=this.game.cache.sounds[a])&&(a.paused||a.pause())},loop:function(a,b){this.play(a,b,!0)},volume:function(a,b){var c=this.game.cache.sounds[a];
c&&(c.volume=b)}};Carrot.SoundManager.prototype.constructor=Carrot.SoundManager;Carrot.Physics=function(a){this.game=a;this.time=this.game.time;return this};
...
Carrot.Physics.Body=function(a,b,c){this.parent=a;this.x=b||0;this.y=c||0;this.velocity=new Carrot.Point(0,0);this.bounce=new Carrot.Point(0,0);this.drag=new Carrot.Point(0,0);this.gravity=new Carrot.Point(0,0);this.acceleration=new Carrot.Point(0,0);this.maxVelocity=new Carrot.Point(1E4,1E4);this.angularDrag=this.angularVelocity=0;this.allowAngularDrag=this.allowAcceleration=this.allowGravity=this.allowDrag=this.allowBounce=!0;this.touching={none:!0,left:!1,right:!1,top:!1,bottom:!1};this.checkCollision=
{none:!1,left:!0,right:!0,top:!0,bottom:!0};this.collideWorldBounds=!1;this.isRectangle=!0;this.isCircle=!1;this.enabled=!0;return this};Carrot.Physics.Body.prototype={setCircle:function(){this.isRectangle=!1;this.isCircle=!0;this.sprite.style.borderRadius=.5*this.sprite.width+"px"},setRectangle:function(){this.isRectangle=!0;this.isCircle=!1;this.sprite.image.style.borderRadius=""}};Carrot.Physics.Body.prototype.constructor=Carrot.Physics.Body;
Carrot.Cache=function(a){this.game=a;this.images={};this.sounds={};this.json={};this.csv={};this.classes={}};Carrot.Cache.prototype={};Carrot.Cache.prototype.constructor=Carrot.Cache;Carrot.Entity=function(a,b,c){this.game=a;this.name=b;this.css=c||{};return this};Carrot.Entity.prototype={add:function(a,b){a&&(b=b||null,this.game.cache.classes[a]=null!==b?b:{})},remove:function(a){delete this.game.cache.classes[a]},edit:function(a,b,c){(a=this.game.cache.classes[a])&&(a[b]=c)}};
Carrot.Entity.prototype.constructor=Carrot.Entity;Carrot.Point=function(a,b){a=a||0;this.setTo(a,b||a);return this};Carrot.Point.prototype={setTo:function(a,b){this.x=a||0;this.y=b||0}};Carrot.Point.prototype.constructor=Carrot.Point;Carrot.Line=function(a,b,c,d){this.end=this.start=null;this.setTo(a||0,b||0,c||0,d||0);return this};Carrot.Line.prototype={setTo:function(a,b,c,d){this.start=new Carrot.Point(a,b);this.end=new Carrot.Point(c,d)}};Carrot.Line.prototype.constructor=Carrot.Line;
Carrot.Rectangle=function(a,b,c,d){this.setTo(a||0,b||0,c||0,d||0);return this};Carrot.Rectangle.prototype={setTo:function(a,b,c,d){this.x=a||0;this.y=b||0;this.width=c||0;this.height=d||0}};Carrot.Rectangle.prototype.constructor=Carrot.Rectangle;Carrot.Circle=function(a,b,c){this.setTo(a||0,b||0,c||0);return this};Carrot.Circle.prototype={setTo:function(a,b,c){this.x=a||0;this.y=b||a;this.diameter=c||0;this.radius=.5*c}};Carrot.Circle.prototype.constructor=Carrot.Circle;
Carrot.ObjectFactory=function(a){this.game=a;return this};Carrot.ObjectFactory.prototype={sprite:function(a,b,c,d,g){void 0===a&&(a=0);void 0===b&&(b=0);void 0===c&&(c=null);void 0===d&&(d=0);void 0===g&&(g=!0);return new Carrot.Sprite(this.game,a,b,c,d,g)},group:function(){return new Carrot.Group(this.game)},timer:function(a,b,c,d){return new Carrot.Timer(this.game,a,b,c,d)}};Carrot.ObjectFactory.prototype.constructor=Carrot.ObjectFactory;
Carrot.AssetLoader=function(a){this.game=a;this.utils=this.game.utils;this.filesToLoad=this.filesLoaded=0;return this};
...
Carrot.Mouse.MIDDLE_BUTTON=1;Carrot.Mouse.RIGHT_BUTTON=2;Carrot.Mouse.prototype={onMouseMove:function(a){this.x=a.offsetX;this.y=a.offsetY},onMouseDown:function(a){this.isDown[a.button]=!0;this.isUp[a.button]=!1},onMouseUp:function(a){this.isDown[a.button]=!1;this.isUp[a.button]=!0}};Carrot.Mouse.prototype.constructor=Carrot.Mouse;Carrot.Events=function(a){this.parent=a;this.game=a.game;return this};Carrot.Events.prototype={onKilled:function(){},onDestroyed:function(){},onRevived:function(){}};
Carrot.Events.prototype.constructor=Carrot.Events;Carrot.Utilities=function(a){this.game=a;return this};Carrot.Utilities.prototype={csvToJson:function(a){var b={};a=a.split(/\n|\r/);for(var c=a[0].replace(/['"]+/g,""),c=c.replace(/\s/g,""),c=c.split(","),d=1;d<a.length;d++){var g=a[d].split(","),e=g[0],e=e.trim();if(""!==e){b[e]={};for(var f=1;f<c.length;f++){var h=c[f],k=parseInt(g[f]);isNaN(k)&&(k=g[f].replace(/['"]+/g,""));b[e][h]=k}}}return b}};Carrot.Utilities.prototype.constructor=Carrot.Utilities;
Carrot.Debug=function(a){this.game=a;return this};
...
void 0!==d?d.innerHTML=a:(d=document.createElement("div"),this.game.background.appendChild(d),d.className="debugText",d.style.position="absolute",d.style.left=b+"px",d.style.top=c+"px",d.style.color="#ffffff",d.style.fontSize="16px",d.style.lineHeight="20px",d.style.textShadow="1px 1px 0px #111111",d.style.userSelect="none",d.style.pointerEvents="none")},test:function(){var a=document.createElement("div");this.game.background.appendChild(a);a.style.position="absolute";a.style.left="100px";a.style.top=
"100px";a.style.width="100px";a.style.height="100px";var b=document.createElement("canvas"),c=b.getContext("2d");c.strokeStyle="#ff0000";c.moveTo(0,0);c.lineTo(100,100);c.lineWidth=5;c.stroke();a.style.backgroundImage="url("+b.toDataURL()+")"}};Carrot.Debug.prototype.constructor=Carrot.Debug;Carrot.SPRITE=0;Carrot.TILESPRITE=1;Carrot.GROUP=2;
!function(a){function b(a){if(p=r(b),!(a<g+t)){d+=a-g;g=a;u(a,d);a>k+h&&(e=f*l*1E3/(a-k)+(1-f)*e,k=a,l=0);l++;for(m=0;d>=c;)if(v(c),d-=c,240<=++m){w=!0;break}q(d/c);x(e,w);w=!1}}var c=1E3/60,d=0,g=0,e=60,f=.9,h=1E3,k=0,l=0,m=0,t=0,y=!1,z=!1,w=!1,n="object"==typeof window?window:a,r=n.requestAnimationFrame||function(){var a=Date.now(),b,d;return function(e){return b=Date.now(),d=Math.max(0,c-(b-a)),a=b+d,setTimeout(function(){e(b+d)},d)}}(),A=n.cancelAnimationFrame||clearTimeout,u=n=function(){},v=
n,q=n,x=n,p;a.MainLoop={getSimulationTimestep:function(){return c},setSimulationTimestep:function(a){return c=a,this},getFPS:function(){return e},getMaxAllowedFPS:function(){return 1E3/t},setMaxAllowedFPS:function(a){return"undefined"==typeof a&&(a=1/0),0===a?this.stop():t=1E3/a,this},resetFrameDelta:function(){var a=d;return d=0,a},setBegin:function(a){return u=a||u,this},setUpdate:function(a){return v=a||v,this},setDraw:function(a){return q=a||q,this},setEnd:function(a){return x=a||x,this},start:function(){return z||
(z=!0,p=r(function(a){q(1);y=!0;k=g=a;l=0;p=r(b)})),this},stop:function(){return y=!1,z=!1,A(p),this},isRunning:function(){return y}};"function"==typeof define&&define.amd?define(a.MainLoop):"object"==typeof module&&null!==module&&"object"==typeof module.exports&&(module.exports=a.MainLoop)}(this);
